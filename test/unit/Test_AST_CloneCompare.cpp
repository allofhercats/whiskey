...
// template <class T>
// void
// testHelper(std::initializer_list<T *> nodes) {
//   for (typename std::initializer_list<T *>::iterator iterA = nodes.begin();
//        iterA != nodes.end(); ++iterA) {
//     T *astA0 = *iterA;
...
//     for (typename std::initializer_list<T *>::iterator iterB = nodes.begin();
//          iterB != iterA; ++iterB) {
//       T *astB0 = *iterB;
...
//   testHelper({new TypeAtomic(AST::ID::TypeAtomicBool),
//               new TypeAtomic(AST::ID::TypeAtomicInt8)});
// }

// TEST(Test_AST_CloneCompare, TypeSymbol) {
//   testHelper({new TypeSymbol("x"), new TypeSymbol("y")});
// }

// TEST(Test_AST_CloneCompare, TypeUnary) {
//   testHelper({new TypeUnary(AST::ID::TypeAccessUnary,
//                             new TypeAtomic(AST::ID::TypeAtomicBool)),
//               new TypeUnary(AST::ID::TypeAccessBinary,
//                             new TypeAtomic(AST::ID::TypeAtomicBool)),
...
//   testHelper({new TypeBinary(AST::ID::TypeAccessUnary,
//                              new TypeAtomic(AST::ID::TypeAtomicBool),
//                              new TypeAtomic(AST::ID::TypeAtomicBool)),
//               new TypeBinary(AST::ID::TypeAccessBinary,
//                              new TypeAtomic(AST::ID::TypeAtomicBool),
//                              new TypeAtomic(AST::ID::TypeAtomicBool)),
//               new TypeBinary(AST::ID::TypeAccessUnary,
//                              new TypeAtomic(AST::ID::TypeAtomicInt8),
//                              new TypeAtomic(AST::ID::TypeAtomicBool)),
//               new TypeBinary(AST::ID::TypeAccessBinary,
//                              new TypeAtomic(AST::ID::TypeAtomicInt8),
...
//   testHelper({new TypeFunction(new TypeAtomic(AST::ID::TypeAtomicBool)),
...
//   testHelper({new ExprLiteralInt(new TypeAtomic(AST::ID::TypeAtomicBool), 0),
//               new ExprLiteralInt(new TypeAtomic(AST::ID::TypeAtomicInt8), 0),
//               new ExprLiteralInt(new TypeAtomic(AST::ID::TypeAtomicBool), 1),
//               new ExprLiteralInt(new TypeAtomic(AST::ID::TypeAtomicInt8),
//               1)});
// }
...
//   testHelper({new ExprSymbol("x"), new ExprSymbol("y")});
// }

// TEST(Test_AST_CloneCompare, ExprUnary) {
//   testHelper({new ExprUnary(AST::ID::TypeAccessUnary, new ExprSymbol("x")),
//               new ExprUnary(AST::ID::TypeAccessBinary, new ExprSymbol("x")),
//               new ExprUnary(AST::ID::TypeAccessUnary, new ExprSymbol("y")),
//               new ExprUnary(AST::ID::TypeAccessBinary, new
//               ExprSymbol("y"))});
// }

// TEST(Test_AST_CloneCompare, ExprBinary) {
//   testHelper({new ExprBinary(AST::ID::TypeAccessUnary, new ExprSymbol("x"),
//                              new ExprSymbol("x")),
//               new ExprBinary(AST::ID::TypeAccessBinary, new ExprSymbol("x"),
//                              new ExprSymbol("x")),
//               new ExprBinary(AST::ID::TypeAccessUnary, new ExprSymbol("y"),
//                              new ExprSymbol("x")),
//               new ExprBinary(AST::ID::TypeAccessBinary, new ExprSymbol("y"),
//                              new ExprSymbol("x")),
//               new ExprBinary(AST::ID::TypeAccessUnary, new ExprSymbol("x"),
//                              new ExprSymbol("y")),
//               new ExprBinary(AST::ID::TypeAccessBinary, new ExprSymbol("x"),
//                              new ExprSymbol("y")),
//               new ExprBinary(AST::ID::TypeAccessUnary, new ExprSymbol("y"),
...
//   testHelper({new ExprCall(new ExprSymbol("x")),
...
//                            {new ExprSymbol("x"), new ExprSymbol("x")}),
//               new ExprCall(new ExprSymbol("y"),
//                            {new ExprSymbol("x"), new ExprSymbol("x")}),
//               new ExprCall(new ExprSymbol("x"),
//                            {new ExprSymbol("y"), new ExprSymbol("x")}),
//               new ExprCall(new ExprSymbol("y"),
//                            {new ExprSymbol("y"), new ExprSymbol("x")}),
//               new ExprCall(new ExprSymbol("x"),
//                            {new ExprSymbol("x"), new ExprSymbol("y")}),
//               new ExprCall(new ExprSymbol("y"),
//                            {new ExprSymbol("x"), new ExprSymbol("y")}),
//               new ExprCall(new ExprSymbol("x"),
//                            {new ExprSymbol("y"), new ExprSymbol("y")}),
//               new ExprCall(new ExprSymbol("y"),
//                            {new ExprSymbol("y"), new ExprSymbol("y")})});
// }

// TEST(Test_AST_CloneCompare, StmtEmpty) { testHelper({new StmtEmpty()}); }

// TEST(Test_AST_CloneCompare, StmtExpr) {
//   testHelper({new StmtExpr(AST::ID::StmtExpr),
...
//        new StmtWhile(new ExprSymbol("y"), new
//        StmtExpr(AST::ID::StmtReturn))});
// }

// TEST(Test_AST_CloneCompare, DeclVariable) {
//   testHelper({new DeclVariable(new TypeAtomic(AST::ID::TypeAtomicBool), "x"),
...
//        new StmtFor(
//            {new DeclVariable(new TypeAtomic(AST::ID::TypeAtomicBool), "x")},
//            new ExprSymbol("x"), {new ExprSymbol("x"), new ExprSymbol("x")}),
//        new StmtFor(
//            {new DeclVariable(new TypeAtomic(AST::ID::TypeAtomicBool), "x")},
//            new ExprSymbol("y"), {new ExprSymbol("x"), new ExprSymbol("x")}),
//        new StmtFor(
//            {new DeclVariable(new TypeAtomic(AST::ID::TypeAtomicBool), "y")},
//            new ExprSymbol("x"), {new ExprSymbol("x"), new ExprSymbol("x")}),
//        new StmtFor(
...
//        new StmtFor(
//            {new DeclVariable(new TypeAtomic(AST::ID::TypeAtomicBool), "x")},
//            new ExprSymbol("x"), {new ExprSymbol("y"), new ExprSymbol("x")}),
//        new StmtFor(
//            {new DeclVariable(new TypeAtomic(AST::ID::TypeAtomicBool), "x")},
//            new ExprSymbol("y"), {new ExprSymbol("y"), new ExprSymbol("x")}),
//        new StmtFor(
//            {new DeclVariable(new TypeAtomic(AST::ID::TypeAtomicBool), "y")},
//            new ExprSymbol("x"), {new ExprSymbol("y"), new ExprSymbol("x")}),
//        new StmtFor(
...
//        new StmtFor(
//            {new DeclVariable(new TypeAtomic(AST::ID::TypeAtomicBool), "x")},
//            new ExprSymbol("x"), {new ExprSymbol("x"), new ExprSymbol("y")}),
//        new StmtFor(
//            {new DeclVariable(new TypeAtomic(AST::ID::TypeAtomicBool), "x")},
//            new ExprSymbol("y"), {new ExprSymbol("x"), new ExprSymbol("y")}),
//        new StmtFor(
//            {new DeclVariable(new TypeAtomic(AST::ID::TypeAtomicBool), "y")},
//            new ExprSymbol("x"), {new ExprSymbol("x"), new ExprSymbol("y")}),
//        new StmtFor(
...
//        new StmtFor(
//            {new DeclVariable(new TypeAtomic(AST::ID::TypeAtomicBool), "x")},
//            new ExprSymbol("x"), {new ExprSymbol("y"), new ExprSymbol("y")}),
//        new StmtFor(
//            {new DeclVariable(new TypeAtomic(AST::ID::TypeAtomicBool), "x")},
//            new ExprSymbol("y"), {new ExprSymbol("y"), new ExprSymbol("y")}),
//        new StmtFor(
//            {new DeclVariable(new TypeAtomic(AST::ID::TypeAtomicBool), "y")},
//            new ExprSymbol("x"), {new ExprSymbol("y"), new ExprSymbol("y")}),
//        new StmtFor(
...
//            {new DeclVariable(new TypeAtomic(AST::ID::TypeAtomicBool), "y"),
//             new DeclVariable(new TypeAtomic(AST::ID::TypeAtomicBool), "y")},
//            new ExprSymbol("y"), {new ExprSymbol("y"), new
//            ExprSymbol("y")})});
// }
...
//       {new StmtForEach(
//            new DeclVariable(new TypeAtomic(AST::ID::TypeAtomicBool), "x"),
//            new ExprSymbol("x"), new StmtExpr(AST::ID::StmtExpr)),
//        new StmtForEach(
//            new DeclVariable(new TypeAtomic(AST::ID::TypeAtomicBool), "y"),
//            new ExprSymbol("x"), new StmtExpr(AST::ID::StmtExpr)),
//        new StmtForEach(
//            new DeclVariable(new TypeAtomic(AST::ID::TypeAtomicBool), "x"),
//            new ExprSymbol("y"), new StmtExpr(AST::ID::StmtExpr)),
//        new StmtForEach(
//            new DeclVariable(new TypeAtomic(AST::ID::TypeAtomicBool), "y"),
//            new ExprSymbol("y"), new StmtExpr(AST::ID::StmtExpr)),
//        new StmtForEach(
//            new DeclVariable(new TypeAtomic(AST::ID::TypeAtomicBool), "x"),
//            new ExprSymbol("x"), new StmtExpr(AST::ID::StmtReturn)),
//        new StmtForEach(
//            new DeclVariable(new TypeAtomic(AST::ID::TypeAtomicBool), "y"),
//            new ExprSymbol("x"), new StmtExpr(AST::ID::StmtReturn)),
//        new StmtForEach(
//            new DeclVariable(new TypeAtomic(AST::ID::TypeAtomicBool), "x"),
//            new ExprSymbol("y"), new StmtExpr(AST::ID::StmtReturn)),
//        new StmtForEach(
//            new DeclVariable(new TypeAtomic(AST::ID::TypeAtomicBool), "y"),
//            new ExprSymbol("y"), new StmtExpr(AST::ID::StmtReturn))});
// }
...
//   testHelper({new StmtBlock(), new StmtBlock({new
//   StmtExpr(AST::ID::StmtExpr)}),
...
//   testHelper(
//       {new DeclFunction(new TypeAtomic(AST::ID::TypeAtomicBool), "x", {},
//                         new StmtExpr(AST::ID::StmtExpr)),
//        new DeclFunction(new TypeAtomic(AST::ID::TypeAtomicInt8), "x", {},
//                         new StmtExpr(AST::ID::StmtExpr)),
//        new DeclFunction(new TypeAtomic(AST::ID::TypeAtomicBool), "y", {},
//                         new StmtExpr(AST::ID::StmtExpr)),
//        new DeclFunction(new TypeAtomic(AST::ID::TypeAtomicInt8), "y", {},
//                         new StmtExpr(AST::ID::StmtExpr)),
//        new DeclFunction(
//            new TypeAtomic(AST::ID::TypeAtomicBool), "x",
//            {new DeclVariable(new TypeAtomic(AST::ID::TypeAtomicBool), "x")},
//            new StmtExpr(AST::ID::StmtExpr)),
//        new DeclFunction(
//            new TypeAtomic(AST::ID::TypeAtomicInt8), "x",
//            {new DeclVariable(new TypeAtomic(AST::ID::TypeAtomicBool), "x")},
//            new StmtExpr(AST::ID::StmtExpr)),
//        new DeclFunction(
//            new TypeAtomic(AST::ID::TypeAtomicBool), "y",
//            {new DeclVariable(new TypeAtomic(AST::ID::TypeAtomicBool), "x")},
//            new StmtExpr(AST::ID::StmtExpr)),
//        new DeclFunction(
//            new TypeAtomic(AST::ID::TypeAtomicInt8), "y",
//            {new DeclVariable(new TypeAtomic(AST::ID::TypeAtomicBool), "x")},
//            new StmtExpr(AST::ID::StmtExpr)),
//        new DeclFunction(
//            new TypeAtomic(AST::ID::TypeAtomicBool), "x",
...
//            {new DeclVariable(new TypeAtomic(AST::ID::TypeAtomicInt8), "x")}),
//        new DeclClass(
//            "x", {new TypeAtomic(AST::ID::TypeAtomicBool)},
//            {new DeclVariable(new TypeAtomic(AST::ID::TypeAtomicInt8), "x")}),
//        new DeclClass(
//            "y", {new TypeAtomic(AST::ID::TypeAtomicBool)},
//            {new DeclVariable(new TypeAtomic(AST::ID::TypeAtomicInt8), "x")}),
//        new DeclClass(
//            "x", {new TypeAtomic(AST::ID::TypeAtomicInt8)},
//            {new DeclVariable(new TypeAtomic(AST::ID::TypeAtomicInt8), "x")}),
//        new DeclClass(
//            "y", {new TypeAtomic(AST::ID::TypeAtomicInt8)},
//            {new DeclVariable(new TypeAtomic(AST::ID::TypeAtomicInt8), "x")}),
//        new DeclClass(
//            "x",
//            {new TypeAtomic(AST::ID::TypeAtomicBool),
...
//             new TypeAtomic(AST::ID::TypeAtomicInt8)},
//            {new DeclVariable(new TypeAtomic(AST::ID::TypeAtomicInt8), "y"),
//             new DeclVariable(new TypeAtomic(AST::ID::TypeAtomicInt8),
//             "y")})});
// }

// TEST(Test_AST_CloneCompare, DeclNamespace) {
//   testHelper(
//       {new DeclNamespace("x"), new DeclNamespace("y"),
//        new DeclNamespace(
//            "x",
//            {new DeclVariable(new TypeAtomic(AST::ID::TypeAtomicBool), "x")}),
//        new DeclNamespace(
...
//            "y",
//            {new DeclVariable(new TypeAtomic(AST::ID::TypeAtomicBool), "y"),
//             new DeclVariable(new TypeAtomic(AST::ID::TypeAtomicBool),
//             "y")})});
// }

// TEST(Test_AST_CloneCompare, Import) {
//   testHelper({new Import("x"), new Import("y")});
// }
