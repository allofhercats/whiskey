...
TEST(Unit_Unicode_StringContainer, ConstructorEncoding) {
	ASSERT_DEATH({
		StringContainer sc(Encoding::Auto);
	}, "");
...
TEST(Unit_Unicode_StringContainer, ConstructorUTF8) {
	ASSERT_DEATH({
		StringContainer sc((const Char8 *)nullptr);
	}, "");
...
TEST(Unit_Unicode_StringContainer, ConstructorUTF8Length) {
	ASSERT_DEATH({
		StringContainer sc((const Char8 *)nullptr, 3);
	}, "");
...
TEST(Unit_Unicode_StringContainer, ConstructorUTF16) {
	ASSERT_DEATH({
		StringContainer sc((const Char16 *)nullptr);
	}, "");

	StringContainer sc0(u"hello");

	ASSERT_TRUE(sc0.getEncoding() == Encoding::UTF16LE || sc0.getEncoding() == Encoding::UTF16BE);
	ASSERT_EQ(sc0.getLength(), 5);
...
TEST(Unit_Unicode_StringContainer, ConstructorUTF16Length) {
	ASSERT_DEATH({
		StringContainer sc((const Char16 *)nullptr, 3);
	}, "");
...
TEST(Unit_Unicode_StringContainer, ConstructorUTF32) {
	ASSERT_DEATH({
		StringContainer sc((const Char32 *)nullptr);
	}, "");

	StringContainer sc0(U"hello");

	ASSERT_TRUE(sc0.getEncoding() == Encoding::UTF32LE || sc0.getEncoding() == Encoding::UTF32BE);
	ASSERT_EQ(sc0.getLength(), 5);
...
TEST(Unit_Unicode_StringContainer, ConstructorUTF32Length) {
	ASSERT_DEATH({
		StringContainer sc((const Char32 *)nullptr, 3);
	}, "");
...
TEST(Unit_Unicode_StringContainer, GetEncoding) {
	...
	ASSERT_EQ(StringContainer(Encoding::UTF16LE).getEncoding(), Encoding::UTF16LE);
	ASSERT_EQ(StringContainer(Encoding::UTF16BE).getEncoding(), Encoding::UTF16BE);
	ASSERT_EQ(StringContainer(Encoding::UTF32LE).getEncoding(), Encoding::UTF32LE);
	ASSERT_EQ(StringContainer(Encoding::UTF32BE).getEncoding(), Encoding::UTF32BE);
}
