...
TEST(Unit_Parsing_ParserContext, Simple) {
  std::vector<Token> tokens = {Token(Token::Sub), Token(Token::Symbol)};
...
TEST(Unit_Parsing_ParserContext, Rule_1) {
  std::vector<Token> tokens = {Token(Token::Sub), Token(Token::Int)};
...
TEST(Unit_Parsing_ParserContext, Rule_2) {
  std::vector<Token> tokens = {Token(Token::Add), Token(Token::Symbol)};
...
TEST(Unit_Parsing_ParserContext, Rule_3) {
  std::vector<Token> tokens = {Token(Token::Sub)};
...
TEST(Unit_Parsing_ParserContext, Rule_4) {
  std::vector<Token> tokens = {Token(Token::Add)};
...
TEST(Unit_Parsing_ParserContext, Rule2_1) {
  std::vector<Token> tokens = {Token(Token::Add), Token(Token::Int)};
...
TEST(Unit_Parsing_ParserContext, TryParseAny_0) {
  ...
  ParserResult res = ctx.parseAny({parseRule, parseRule2});
