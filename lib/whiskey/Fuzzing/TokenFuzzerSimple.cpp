	...
	while (getLength() < nChars) {
		...
		switch (r) {
			case 0: // symbol
				...
				length = (rand() % (SYMBOL_LENGTH_MAX - SYMBOL_LENGTH_MIN)) + SYMBOL_LENGTH_MIN;
				...
				for (int i = 0; i < length; i++) {
					...
					switch (r2) {
						...
						case 3: // underscore
							...
							break;
						default:
							W_ASSERT_UNREACHABLE("Reduce modulo bound for random case switch (got case " << r2 << ").");
							break;
					}
				}
			...
			case 64:
				...
				break;
			default:
				W_ASSERT_UNREACHABLE("Reduce modulo bound for random case switch (got case " << r << ").");
		}
	}
}
