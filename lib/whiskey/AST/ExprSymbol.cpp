...
void ExprSymbol::onGetChildrenExprSymbol(
    std::queue<ContainerRef<AST>> &children) {
}

ExprSymbol::ExprSymbol(std::string value,
                       std::vector<Container<AST>> templateEvalArgs)
    : Expr(AST::ID::ExprSymbol, Range()), value(value),
      templateEvalArgs(templateEvalArgs) {
}

ExprSymbol::ExprSymbol(Range range,
                       std::string value,
                       std::vector<Container<AST>> templateEvalArgs)
    : Expr(AST::ID::ExprSymbol, range), value(value),
      templateEvalArgs(templateEvalArgs) {
