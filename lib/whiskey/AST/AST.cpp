...
bool AST::isTypeAtomic(ID id) {
	return id == AST::ID::TypeAtomicInt8
		|| id == AST::ID::TypeAtomicInt16
		|| id == AST::ID::TypeAtomicInt32
		|| id == AST::ID::TypeAtomicInt64
		|| id == AST::ID::TypeAtomicUInt8
		|| id == AST::ID::TypeAtomicUInt16
		|| id == AST::ID::TypeAtomicUInt32
		|| id == AST::ID::TypeAtomicUInt64
		|| id == AST::ID::TypeAtomicFloat32
		|| id == AST::ID::TypeAtomicFloat64
...
bool AST::isExpr(ID id) {
	return isExprLiteralInt(id)
		|| isExprLiteralFloat(id)
		|| isExprSymbol(id)
		|| isExprUnary(id)
		|| isExprBinary(id)
		|| isExprCall(id);
...
bool AST::isExprUnary(ID id) {
	return id == AST::ID::ExprAccessUnary
		|| id == AST::ID::ExprIncPre
		|| id == AST::ID::ExprIncPost
		|| id == AST::ID::ExprDecPre
		|| id == AST::ID::ExprDecPost
		|| id == AST::ID::ExprNegate
		|| id == AST::ID::ExprBitNot
		|| id == AST::ID::ExprBoolNot;
}

bool AST::isExprBinary(ID id) {
	return id == AST::ID::ExprAccessBinary
		|| id == AST::ID::ExprExp
		|| id == AST::ID::ExprMul
		|| id == AST::ID::ExprDiv
		|| id == AST::ID::ExprDivInt
		|| id == AST::ID::ExprDivReal
		|| id == AST::ID::ExprAdd
		|| id == AST::ID::ExprSub
		|| id == AST::ID::ExprMod
		|| id == AST::ID::ExprBitShR
		|| id == AST::ID::ExprBitShL
		|| id == AST::ID::ExprBitAnd
		|| id == AST::ID::ExprBitOr
		|| id == AST::ID::ExprBitXor
		|| id == AST::ID::ExprLT
		|| id == AST::ID::ExprLE
		|| id == AST::ID::ExprGT
		|| id == AST::ID::ExprGE
		|| id == AST::ID::ExprNE
		|| id == AST::ID::ExprEQ
		|| id == AST::ID::ExprBoolAnd
		|| id == AST::ID::ExprBoolOr
