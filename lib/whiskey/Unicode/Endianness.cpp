...
uint16_t swapByteOrder16(uint16_t value) {
  return (uint16_t)getNthByte(value, 1) | (uint16_t)getNthByte(value, 0) << 8;
}

uint32_t swapByteOrder32(uint32_t value) {
  return (uint32_t)getNthByte(value, 3) | (uint32_t)getNthByte(value, 2) << 8 |
         (uint32_t)getNthByte(value, 1) << 16 |
         (uint32_t)getNthByte(value, 0) << 24;
}

uint64_t swapByteOrder64(uint64_t value) {
  return (uint64_t)getNthByte(value, 7) | (uint64_t)getNthByte(value, 6) << 8 |
