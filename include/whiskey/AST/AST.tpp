...
bool AST::compare(const Container<ValueType> &lhs,
...
template <class ValueType>
bool AST::compare(const std::vector<Container<ValueType>> &lhs,
...
template <class ValueType>
bool AST::compare(const std::vector<Ref<ValueType>> &lhs,
...
template <class ValueType>
bool AST::compare(const std::vector<CRef<ValueType>> &lhs,
