...
public:
  ...
  static bool compare(const Container<ValueType> &lhs,
                      const Container<ValueType> &rhs);
  ...
  template <class ValueType>
  static bool compare(const std::vector<Container<ValueType>> &lhs,
                      const std::vector<Container<ValueType>> &rhs);

  template <class ValueType>
  static bool compare(const std::vector<Ref<ValueType>> &lhs,
                      const std::vector<Ref<ValueType>> &rhs);

  template <class ValueType>
  static bool compare(const std::vector<CRef<ValueType>> &lhs,
                      const std::vector<CRef<ValueType>> &rhs);
