...
public:
	...
	Location(std::string pathOverride = "", size_t offset = (size_t)-1, unsigned int line = 0, unsigned int column = 0);
	Location(const Source &source, size_t offset = 0, unsigned int line = 1, unsigned int column = 1);
	Location(const Source &source, std::string pathOverride, size_t offset = 0, unsigned int line = 1, unsigned int column = 1);
