...
void printLiteralInt(std::ostream &os, int64_t value, unsigned int base = 10, bool prefix = true, unsigned int width = 0);
void printLiteralUInt(std::ostream &os, uint64_t value, unsigned int base = 10, bool prefix = true, unsigned int width = 0);
